(function() {
    ...
    angular.module("itaca.components").component("chRatesheetRoomTypeRateAmount", {
    	require: {
		...
		controller: RatesheetRoomTypeRateAmountCtrl,
    	templateUrl: "/tpls/ratesheet/ratesheet-room-type-rate-amount.tpl"
    });
    
    /* @ngInject */
    function RatesheetRoomTypeRateAmountCtrl($scope, $mdMedia, $mdPanel) {
