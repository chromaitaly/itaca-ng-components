	...
	angular.module("itaca.components").component("chHotelMapInfoWindow", {
		...
		template:
			'<info-window id="hotel-iw">' +
		     	'<div ng-if="$ctrl.hotel" ng-non-bindable style="max-width: 300px;">' +
		     		'<div ng-if="$ctrl.showGallery" style="width: 100; max-height: 200px">' +
			     		'<div class="relative">' +				   		  			
							'<div class="img-top-bar">' +
								...
								'</div>' +
							'</div>' +	
							'<img ng-if="!$ctrl.hotel.gallery.length" class="main-image" ng-attr-alt="{{$ctrl.hotel.name}}" src="/resources/public/img/header.jpg">' +
