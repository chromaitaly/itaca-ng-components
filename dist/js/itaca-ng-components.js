...
(function() {
    ...
    function ArrayOptionCtrl($scope) {
        ...
        this.$postLink = function() {
            ctrl.$$option = {
                value: ctrl.ngValue,
                selected: ctrl.chArrayInputCtrl.$isSelected(ctrl.ngValue)
            };
