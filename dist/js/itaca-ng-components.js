...
(function() {
    ...
    function RoomInfoCtrl($scope, Navigator) {
        ...
        this.$getIncludedFreeServices = function() {
            ctrl.$$includedServices = _.filter(ctrl.$$room.services, function(srv) {
                return srv.bookability == "INCLUDED" && (srv.category != "ROOM" || !srv.paymentType || srv.paymentType == "FREE");
            });
        };
        this.$getIncludedPaidServices = function() {
            ctrl.chRoomCtrl.$$includedPaidServices = _.filter(ctrl.$$room.services, function(srv) {
                return srv.bookability == "INCLUDED" && srv.category == "ROOM" && srv.paymentType && srv.paymentType != "FREE";
            });
        };
