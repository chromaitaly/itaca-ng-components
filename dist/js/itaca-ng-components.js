...
(function() {
    ...
    angular.module("itaca.components").component("chArrayOption", {
        ...
        template: '<md-button class="{{$ctrl.buttonClass}}" ng-class="$ctrl.$$option.selected ? $ctrl.selectedClass : \'\'" ' + 'ng-click="$ctrl.$toggle()" aria-label="Toggle option">' + '<md-icon ng-if="$ctrl.iconClass" ng-show="!$ctrl.$$option.selected || !$ctrl.selectedIconClass" ' + 'class="material-icons {{$ctrl.iconClass}}"></md-icon>' + '<md-icon ng-show="$ctrl.selectedIconClass && $ctrl.$$option.selected" ' + 'class="material-icons {{$ctrl.selectedIconClass}}"></md-icon>' + '<span ng-if="$ctrl.label" class="{{$ctrl.labelClass}}" ng-bind-html="$ctrl.label"></span>' + "</md-button>"
    });
...
(function() {
    "use strict";
    RatesheetRateEditCtrl.$inject = [ "$scope", "$mdMedia", "REGEXP" ];
...
angular.module("itaca.components").run([ "$templateCache", function($templateCache) {
    ...
    $templateCache.put("/tpls/simple-stepper/simple-step.tpl", '<div class="ch-simple-stepper" ng-class="{\'ch-active\': $ctrl.$active }"><ch-simple-steppers-header class="ch-simple-steppers-header ch-simple-steppers-vertical"><md-button class="ch-simple-stepper-indicator" ng-class="{\n' + "\t        'ch-active': $ctrl.$$stepNumber === $ctrl.chStepperCtrl.currentStep,\n" + "\t        'ch-completed': $ctrl.chStepperCtrl.isCompleted($ctrl.$$stepNumber),\n" + "\t        'ch-error': $ctrl.hasError,\n" + "\t        'ch-simple-stepper-optional': $ctrl.optional || $ctrl.hasError\n" + '        \t}" ng-click="$ctrl.chStepperCtrl.goto($ctrl.$$stepNumber)" ng-disabled="$ctrl.chStepperCtrl.linear || $ctrl.$$stepNumber === $ctrl.chStepperCtrl.currentStep" aria-label="Go to step"><div class="ch-simple-stepper-indicator-wrapper"><div class="ch-simple-stepper-number" ng-hide="$ctrl.hasError"><span ng-if="!$ctrl.chStepperCtrl.isCompleted($ctrl.$$stepNumber)"><span ng-if="!$ctrl.iconClass" ng-bind="$ctrl.$$stepNumber+1"></span><span ng-if="$ctrl.iconClass"><md-icon class="{{$ctrl.iconClass}}"></md-icon></span></span><span ng-if="$ctrl.chStepperCtrl.isCompleted($ctrl.$$stepNumber)"><md-icon class="ch-simple-stepper-icon material-icons mdi" ng-class="$ctrl.iconCompletedClass ? $ctrl.iconCompletedClass : \'mdi-check ch-18\'"></md-icon></span></div><div class="ch-simple-stepper-error-indicator" ng-show="$ctrl.hasError"><md-icon class="steppers-warning mdi mdi-alert ch-24"></md-icon></div><div class="ch-simple-stepper-title"><span ng-bind-html="$ctrl.label"></span><small ng-if="$ctrl.optional" ng-show="!$ctrl.hasError" ng-bind-html="$ctrl.optionalLabel"></small><small class="ch-simple-stepper-error-message" ng-bind-html="$ctrl.message"></small></div></div></md-button><div class="ch-simple-stepper-feedback-message" ng-show="$ctrl.chStepperCtrl.hasFeedback"><span ng-bind-html="$ctrl.chStepperCtrl.feedbackMessage"></span></div></ch-simple-steppers-header><ch-simple-steppers-scope layout="column" class="ch-simple-steppers-scope" ng-if="$ctrl.$active" ng-transclude></ch-simple-steppers-scope></div>');
    $templateCache.put("/tpls/simple-stepper/simple-stepper.tpl", '<div flex class="ch-simple-steppers" ng-class="{ \n' + "    'ch-simple-steppers-linear': $ctrl.linear, \n" + "    'ch-simple-steppers-alternative': $ctrl.alternative,\n" + "    'ch-simple-steppers-vertical': $ctrl.vertical,\n" + "    'ch-simple-steppers-mobile-step-text': $ctrl.mobileStepText,\n" + "    'ch-simple-steppers-has-feedback': $ctrl.hasFeedback\n" + '    }"><div class="ch-simple-steppers-header-region"><ch-simple-steppers-header class="ch-simple-steppers-header ch-simple-steppers-horizontal ch-whiteframe-1dp"><md-button class="ch-simple-stepper-indicator" ng-repeat="(stepNumber, $step) in $ctrl.steps track by $index" ng-class="{\n' + "                'ch-active': stepNumber === $ctrl.currentStep.index,\n" + "                'ch-completed': $ctrl.isCompleted(stepNumber),\n" + "                'ch-error': $step.hasError,\n" + "                'ch-simple-stepper-optional': $step.optional || $step.hasError\n" + '            \t}" ng-click="$ctrl.goto(stepNumber)" ng-disabled="$ctrl.linear || stepNumber === $ctrl.currentStep.index || $step.ngDisabled" aria-label="Go to step"><div class="ch-simple-stepper-indicator-wrapper"><div class="ch-simple-stepper-number" ng-hide="$step.hasError"><span ng-if="!$ctrl.isCompleted(stepNumber)"><span ng-if="!$step.iconClass" ng-bind="stepNumber+1"></span><span ng-if="$step.iconClass"><ch-icon class="{{$step.iconClass}}"></ch-icon></span></span><span ng-if="$ctrl.isCompleted(stepNumber)"><ch-icon class="ch-simple-stepper-icon material-icons mdi" ng-class="$step.iconCompletedClass ? $step.iconCompletedClass : \'mdi-check ch-18\'"></ch-icon></span></div><div class="ch-simple-stepper-error-indicator" ng-show="$step.hasError"><ch-icon class="steppers-warning mdi mdi-alert ch-24"></ch-icon></div><div class="ch-simple-stepper-title"><span ng-bind-html="$step.label"></span><small ng-if="$step.optional" ng-show="!$step.hasError" ng-bind-html="$step.optionalLabel"></small><small class="ch-simple-stepper-error-message" ng-show="$step.hasError" ng-bind-html="$step.message"></small></div></div></md-button></ch-simple-steppers-header><ch-simple-steppers-mobile-header class="ch-simple-steppers-mobile-header"><md-toolbar flex="none" class="ch-whiteframe-1dp" style="background: #f6f6f6 !important; color: #202020 !important"><div class="md-toolbar-tools"><h3><span ng-bind-html="$ctrl.labelStep"></span>&nbsp;<span ng-bind-html="$ctrl.currentStep.index+1"></span>&nbsp;<span ng-bind-html="$ctrl.labelOf"></span>&nbsp;<span ng-bind-html="$ctrl.steps.length"></span>:<span class="ch-simple-stepper-title">&nbsp;<span ng-bind-html="$ctrl.currentStep.label"></span><small ng-if="$ctrl.currentStep.optional">&nbsp;(<span ng-bind-html="$ctrl.currentStep.optionalLabel"></span>)</small></span></h3></div></md-toolbar></ch-simple-steppers-mobile-header><div class="ch-simple-stepper-feedback-message" ng-show="$ctrl.hasFeedback"><span ng-bind-html="$ctrl.feedbackMessage"></span></div></div><ch-simple-steppers-content class="ch-simple-steppers-content" ng-transclude></ch-simple-steppers-content><div class="ch-simple-steppers-overlay"></div></div>');
