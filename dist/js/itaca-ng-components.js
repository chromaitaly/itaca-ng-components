        ...
        this.$initFrequencies = function() {
            ...
            _.forEach(frequencies, function(frequency) {
                ctrl.$$frequencies.push({
                    value: frequency,
                    disabled: _.includes(ctrl.disabledSizes, frequency) && !(ctrl.paymentOption && ctrl.paymentOption.frequency == frequency)
                });
            });
        };
